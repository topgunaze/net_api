...
#define SYSCONFDIR "/mnt/cfg/"

/* babeld vty socket */
#define BABEL_VTYSH_PATH "/etc/babeld.vty"

/* bgpd vty socket */
#define BGP_VTYSH_PATH "/etc/bgpd.vty"
...
/* isisd vty socket */
#define ISIS_VTYSH_PATH "/etc/isisd.vty"
...
/* ospf6d vty socket */
#define OSPF6_VTYSH_PATH "/etc/ospf6d.vty"

/* ospfd vty socket */
#define OSPF_VTYSH_PATH "/etc/ospfd.vty"
...
/* babeld PID */
#define PATH_BABELD_PID "/etc/babeld.pid"

/* bgpd PID */
#define PATH_BGPD_PID "/etc/bgpd.pid"

/* isisd PID */
#define PATH_ISISD_PID "/etc/isisd.pid"

/* ospf6d PID */
#define PATH_OSPF6D_PID "/etc/ospf6d.pid"

/* ospfd PID */
#define PATH_OSPFD_PID "/etc/ospfd.pid"

/* pimd PID */
#define PATH_PIMD_PID "/etc/pimd.pid"

/* ripd PID */
#define PATH_RIPD_PID "/etc/ripd.pid"

/* ripngd PID */
#define PATH_RIPNGD_PID "/etc/ripngd.pid"

/* watchquagga PID */
#define PATH_WATCHQUAGGA_PID "/etc/watchquagga.pid"

/* zebra PID */
#define PATH_ZEBRA_PID "/etc/zebra.pid"

/* pimd vty socket */
#define PIM_VTYSH_PATH "/etc/pimd.vty"

/* test vty socket */
#define TEST_VTYSH_PATH "/etc/testd.vty"
#define DEVCTRL_VTYSH_PATH "/etc/devctrld.vty"
#define T_VTYSH_PATH "/etc/12345.vty"

#define ALARM_VTYSH_PATH "/etc/alarm.vty"

#define SWACL_VTYSH_PATH "/etc/swacl.vty"
#define SYSCTRL_VTYSH_PATH "/etc/sysctrl.vty"

#define SNMPD_VTYSH_PATH "/etc/snmpd.vty"

#define L2_VTYSH_PATH "/etc/l2.vty"
#define RSTP_VTYSH_PATH "/etc/rstp.vty"
#define HAL_VTYSH_PATH "/etc/hal.vty"
...
/* ripng vty socket */
#define RIPNG_VTYSH_PATH "/etc/ripngd.vty"

/* rip vty socket */
#define RIP_VTYSH_PATH "/etc/ripd.vty"
...
/* zebra api socket */
#define ZEBRA_SERV_PATH "/etc/zserv.api"

/* zebra vty socket */
#define ZEBRA_VTYSH_PATH "/etc/zebra.vty"
...
/* Work around a bug in Sun C++: it does not support _Restrict or
   __restrict__, even though the correstfding Sun C compiler ends up with
...
#define _ENABLE_VTY_SPACE_EXPAND_
