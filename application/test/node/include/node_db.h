...
#ifndef __NODE_DB_H__
#define __NODE_DB_H__

#include "adaptor_net_if.h"
//#include "node_common.h"
#include "node_thread_pool.h"
...
typedef enum
{
    ...
    NODE_AUTH_MODE_AUTO,
}NODE_ONU_AUTH_MODE_E;

typedef enum
{
    NODE_ONU_AUTH_TIME_MODE_ALWAYS   = 0,
    NODE_ONU_AUTH_TIME_MODE_ONCE_AGING,
    NODE_ONU_AUTH_TIME_MODE_ONCE_NO_AGING,
}NODE_ONU_AUTH_TIME_MODE_E;
...
int
node_onu_db_onu_auth_pwd_tbl_add(
                const uint8_t ni,
                const uint16_t onu_id,
                const char *p_password,
                const NODE_ONU_AUTH_TIME_MODE_E time_mode,
...
int
node_onu_db_onu_auth_pwd_tbl_check(
                const uint8_t ni,
                const char *p_password,
                uint32_t *p_onu_uint,
                uint8_t *p_auth_mode);
...
int
node_onu_db_onu_auth_pwd_tbl_set_authed(
                const uint32_t onu_uint);

int
node_onu_db_onu_auth_pwd_tbl_get_pwd(
                const uint32_t onu_uint,
                uint8_t *p_auth_mode,
                char *p_password);
...
int
node_onu_db_onu_auth_pwd_tbl_get_onu_uint_by_pwd_first(
                const uint32_t onu_uint_start,
                const char *p_password,
                uint32_t *p_onu_uint,
                uint8_t *p_auth_mode);
...
int
node_onu_db_onu_auth_loid_tbl_add(
                const uint8_t ni,
                const uint16_t onu_id,
                const NODE_ONU_AUTH_MODE_E auth_mode,
                const node_loid_user *p_loid_user,
                const node_loid_co *p_loid_co, //can be null
                const NODE_ONU_AUTH_TIME_MODE_E time_mode,
                const uint32_t sec_duration,
                const uint32_t lineprofile_id,
                const uint32_t srvprofile_id);
...
int
node_onu_db_onu_auth_loid_tbl_check(
                const node_loid_user *p_loid_user,
                const node_loid_co *p_loid_co,
                uint32_t *p_onu_uint,
                uint8_t *p_auth_mode);
...
int
node_onu_db_onu_auth_loid_tbl_set_authed(
                const uint32_t onu_uint);

int
node_onu_db_onu_auth_loid_tbl_get_loid(
                const uint32_t onu_uint,
                uint8_t *p_auth_mode,
                node_loid_user *p_loid_user,
                node_loid_co *p_loid_co);
...
int
node_onu_db_onu_auth_loid_tbl_get_onu_uint(
                const node_loid_user *p_loid_user,
                uint32_t *p_onu_uint,
                uint8_t *p_auth_mode);
...
int
node_onu_db_autoauth_rule_tbl_set_global_switch(
                uint8_t sw_val);

int
node_onu_db_autoauth_rule_tbl_get_global_switch(
                uint8_t *p_sw);

int
node_onu_db_autoauth_rule_tbl_set_switch(
                const uint16_t dev_id,
                const uint16_t port_id,
                const uint8_t  sw_val);

int
node_onu_db_autoauth_rule_tbl_get_switch(
                uint16_t dev_id,
                uint16_t port_id,
                uint8_t* p_sw);
...
int
node_onu_db_autoauth_rule_tbl_get_mode(
                uint8_t *p_mode,
...
int
node_onu_db_autoauth_rule_tbl_get_rule_count(
                uint32_t* p_count);


int
node_onu_db_autoauth_rule_tbl_reset_mode(
                const uint8_t mode,
...
int
node_onu_db_autoauth_rule_tbl_add(
...
int
node_onu_db_autoauth_rule_tbl_check(
                const char * p_vendor,
                const char * p_equipment_id,
                const char * p_sw_version,
...
int
node_onu_db_autoauth_rule_tbl_get_first(
...
int
node_onu_db_autoauth_rule_tbl_del(
                const uint32_t rule_id_offset); //start from 0

int
node_onu_db_autoauth_rule_tbl_del_all(void);
