...
typedef enum
{
    ...
    APP_ZK_RC_NET_INIT,
    APP_ZK_RC_NET_NOT_CONNECT,
    APP_ZK_RC_NET_MAP_ALREADY_EXIST,
    APP_ZK_RC_NET_MAP_IS_FULL,

    APP_ZK_RC_PARAM_NULL,
    APP_ZK_RC_PARAM_OUT_OF_RANGE,
    APP_ZK_RC_PARAM_INVALID,
    APP_ZK_RC_PARAM_GET,
    APP_ZK_RC_PARAM_SET,

    APP_ZK_RC_MSG_QUEUE_CREATE,
    APP_ZK_RC_MSG_QUEUE_PUT,
    
    APP_ZK_RC_TASK_CREATE,
    
    APP_ZK_RC_MSG_SYN_VARIFY,
    APP_ZK_RC_MSG_SYN_WAITE,

    APP_ZK_RC_MEM_ALLOCATION,

    APP_ZK_RC_PORT_OPERATION,
    
    APP_ZK_RC_IPC_OPERATION,
    APP_ZK_RC_IPC_PORT_ABSENSE,
    
    APP_ZK_RC_IMPOSSIBLE_ERROR,
...
#define OBJ_APP_ZK_RC_OFFSET    400000000
