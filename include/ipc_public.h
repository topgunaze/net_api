...
#define IPC_EVENT_SNMP_PORT_SWITCH  IPC_EVENT_MSG(52)
...
#define IPC_ONT_LOOP_DETECT_TIMES_MSG IPC_PKT_MSG(8)
...
//#define IPC_EONU_ONLINE_FLAG_AND_PORT_NUM_GET IPC_SWITCH_MSG(98)
...
#define IPC_SWITCH_IGMP_TABLE_MSG_GET IPC_IGMP_MSG(23)
...
typedef enum
{
    IPC_GMSG_BASE = IPC_MSG_BASE+600, /*700*/
...
#define IPC_SYS_MONITOR_PORT_INFO_GET   IPC_SYS_CTRL_MSG(26)
...
#define IPC_SYS_MONITOR_PORT_DISABLE    IPC_SYS_CTRL_MSG(34)
...
#define IPC_MONITOR_PORT_INFO_GET  IPC_MONITOR_MSG(1)
...
#define IPC_SWITCH_DRV_ALL_RST              IPC_DRV_MSG(11)
...
#define IPC_EONU_UNI_STATISTICS_CURRENT_MSG_GET IPC_MSG(2)
#define IPC_EONU_UNI_STATISTICS_CURRENT_MSG_SET IPC_MSG(3)
#define IPC_EONU_ETH_PORT_INFO_GET IPC_MSG(4)
#define IPC_EONU_ETH_PORT_VLAN_SET IPC_MSG(5)
#define IPC_EONU_ETH_PORT_VLAN_DEL IPC_MSG(6)
#define IPC_SWITCH_DHCP_ONU_ID_AND_UNI_ID_GET IPC_MSG(7)
#define IPC_ONT_DEACTIVE_MSG              IPC_MSG(8)

#define IPC_MAC_ADDR_FLUSH_ALL_MSG        IPC_MSG(10)
#define IPC_MAC_ADDR_FLUSH_DYNAMIC_MSG    IPC_MSG(11)
#define IPC_MAC_ADDR_FLUSH_PORT_MSG       IPC_MSG(12)
#define IPC_MAC_ADDR_FLUSH_VLAN_MSG       IPC_MSG(13)
#define IPC_MAC_ADDR_LEARNING_ADMIN       IPC_MSG(14)
#define IPC_MAC_ADDR_AGING_TIME           IPC_MSG(15)
